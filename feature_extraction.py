...
def get_features(id, sentence):
    ...
    return NLPFeatures(id, words, sentence, lemmas, stems, tags, dependency_parse_tree, hypernyms, hyponyms, meronyms, holonyms, synonymns, rootOfSentence, entities, entity_labels)
